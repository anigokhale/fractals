 ...
 * include  versions. Because creating new objects can be computationally
...
public class PVector implements Serializable {
   ...
   * @return the random PVector
   */
   public PVector random2D(PApplet parent) {
   ...
   * @return the random PVector
   */
   public PVector random2D(PVector target, PApplet parent) {
    return (parent == null) ?
   ...
   * @return the random PVector
   */
   public PVector random3D(PApplet parent) {
   ...
   * @return the random PVector
   */
   public PVector random3D(PVector target, PApplet parent) {
    double angle;
    double vz;
    if (parent == null) {
   ...
   * @return the PVector
   */
   public PVector fromAngle(double angle, PVector target) {
    if (target == null) {
   ...
   * adds two vectors together is a  method and returns a PVector, the
   ...
   * method that subtracts two vectors is a  method and returns a
   ...
   */
   public PVector mult(PVector v, double n) {
   ...
   * @param target PVector in which to store the result
   */
   public PVector mult(PVector v, double n, PVector target) {
    if (target == null) {
   ...
   */
   public PVector div(PVector v, double n) {
    return div(v, n, null);
  }
   ...
   * @param target PVector in which to store the result
   */
   public PVector div(PVector v, double n, PVector target) {
    if (target == null) {
      target = new PVector(v.x/n, v.y/n, v.z/n);
    } else {
      target.set(v.x/n, v.y/n, v.z/n);
  ...
  public PVector lerp(PVector v, double amt) {
    ...
    z = PApplet.lerp((float)z, (float)v.z, (float)amt);
    return this;
  }
   ...
   */
  public  PVector lerp(PVector v1, PVector v2, double amt) {
    PVector v = v1.copy();
    v.lerp(v2, amt);
    return v;
  }
   ...
   */
   public double angleBetween(PVector v1, PVector v2) {
